...
export default function AdminDashboard() {
  ...
  const totalCount = deliveryStatus.reduce((sum, item) => sum + item.count, 0);
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        {/* Total Count Card */}
        <div className="card bg-base-100 shadow-md border border-base-200 flex flex-col items-center justify-center p-6">
